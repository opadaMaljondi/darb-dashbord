    ...
    <script>
        ...
        var options = {
            ...
            handler: function (response){
                ...
                var redirectUrl = paymentSuccessUrl + "?payment_for=" + payment_for + "&user_id=" + user_id + "&request_id=" + request_id + "&amount=" + request_amount + "&order_id=" + orderId + "&plan_id=" + plan_id;
